...
const DigitalBooth = () => {
	return (
		<section>
			<VideoHero heading={'Unforgettable Prints'} subtitle={'Transform Your Event with our Premium Photo Booth'} path={'/videos/boothPromoVideos/PremiumBoothPromoVideo01.mp4'} />
			...
			<BoothFeatures
				booth='premiumBooth'
				includedFeaturesDescription='The Following Features Are Included In Our Premium Photo Booth Packages'
			/>
