...
const Footer = () => {
	return (
		<div className='bg-gray-100 pt-5 lg:pt-10 pb-40'>
			<section>
				<div className='flex flex-col lg:flex-row justify-center items-center lg:items-start text-lg lg:text-base space-y-10 lg:space-y-0'>
					<div className='lg:w-1/6 w-2/3 text-center flex flex-col lg:mx-20'>
					...
					<div className='lg:w-1/6 w-2/3 text-center flex flex-col lg:mx-20'>
						...
						<Link href="/#request-quote" className='text-blue-400'>Instant Quote</Link>
